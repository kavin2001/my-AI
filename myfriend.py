...
print(voices[0].id)
engine.setProperty('voice', voices[1].id) # [len(voices) - 1]
...
def wish():
    ...
    speak("i am you friend, please tell me how can i help you")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('mkmkavin2001@gmail.com', 'password')  # your email address , your password    server.sendmail('senderemail@gmail.com', to, content)  # your email address
    server.close()
...
# ----- my jobs
            ...
            speak("I'm good, thank you for asking. I hope you're doing well too. If i can help with anything, just ask 😊")

        elif "i am fine" in query or "i am good" in query:
            speak("It's good to know that your fine")
            if "i am ok" in query or "good" in query or "Mmmmm.." in query or "ya" in query:
                speak("I'm sorry. ")
